...
Use this pack to help an AI coding agent work with `sverklo/sverklo` safely and verifiably.

## When To Use

- The user wants `give AI coding hosts a local-first Sverklo memory workflow with workspace initialization, indexing checks, receipt verification, and safe recovery`.
